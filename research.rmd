...
**Souto-Maior, J.** Black-White advanced enrollment inequalities and the racial composition of schools: an agent-based modeling investigation *(expected submission: June, 2022)*. 
<br>
...
**Souto-Maior**, J. & Shroff, R. Testing for "unjustified" Black-White advanced enrollment inequalities: evidence from NYC high schools *(expected submission: May, 2022)*. 
<br>
...
**Souto-Maior, J.** Determinants of race- and class-based educational inequality within Brazilian high schools *(expected submission: June, 2022)*. 
<br> 
