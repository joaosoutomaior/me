...
<br>
<button onclick="readMore('1')" class="button">Info</button>
...
<br>
<button onclick="readMore('2')" class="button">Info</button> 
<span class="dots"></span><span class="more" style="display: none;">
<p2>
...
<br> 
<button onclick="readMore('3')" class="button">Info</button> 
...
<br>
<button onclick="readMore('4')" class="button">Info</button> 
